...
import 'package:sharehandsstore/model/ItemAttributes.dart';
import 'package:sharehandsstore/model/ProductModel.dart';
import 'package:sharehandsstore/model/SectionModel.dart';
import 'package:sharehandsstore/model/VendorModel.dart';
import 'package:sharehandsstore/model/categoryModel.dart';
import 'package:sharehandsstore/services/FirebaseHelper.dart';
import 'package:sharehandsstore/services/helper.dart';
import 'package:sharehandsstore/services/show_toast_dailog.dart';
import 'package:sharehandsstore/theme/app_them_data.dart';
import 'package:sharehandsstore/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
      ...
      for (SectionModel sectionModel in value) {
        if (sectionModel.id == section_id) {
          setState(() {
            ...
            if (sectionModel.isProductDetails == true) {
              veg = true;
            }
          });
                          ...
                          children: [
                            Container(
                              decoration: ShapeDecoration(
                                color: isDarkMode(context) ? AppThemeData.danger600 : AppThemeData.danger50,
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "Product prices include a 15% admin commission. For instance, a \$100 product will cost \$115 for the customer. 15% will be applied automatically."
                                      .tr(),
                                  style: TextStyle(color: isDarkMode(context) ? AppThemeData.danger200 : AppThemeData.danger400, fontSize: 14, fontFamily: AppThemeData.medium),
                                ),
                              ),
                            ),
                            Padding(
                                              ...
                                              children: [
                                                Expanded(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text("${"File Name : ".tr()}$digitalProductFileName ", style: TextStyle(color: Colors.black)),
                                                  ],
                                                )),
                                                InkWell(
                                                  onTap: () async {
                                                    ...
                                                    if (result != null) {
                                                      ...
                                                      if (sizeInMb <= double.parse(fileSize)) {
                                                        ...
                                                        final snackBar = SnackBar(
                                                          content: Text('${"Please select less than ".tr()}${fileSize.toString()}  ${"mb file.".tr()}').tr(),
                                                        );
                                                        ScaffoldMessenger.of(context).showSnackBar(snackBar);
                                                      }
                                                    } else {
                                                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Please select zip file!".tr())));
                                                      // User canceled the picker
                                                    }
                                                  },
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                                        border: Border.all(color: Color(COLOR_PRIMARY), width: 2), borderRadius: BorderRadius.all(Radius.circular(8))),
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                          ...
                                                          onTap: () {
                                                            setState(() {
                                                              ...
                                                              for (int i = 0; i < itemAttributes!.attributes!.length; i++) {
                                                                // main Attribute loop
                                                                if (itemAttributes!.attributes![i].attributeOptions!.isNotEmpty)
                                                                  listArary.add(itemAttributes!.attributes![i].attributeOptions!);
                                                              }
                              ...
                              child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        rprice.text.toString().trim().isEmpty ? amountShow(amount: "0") : amountShow(amount: rprice.text),
                            ...
                            Visibility(
                              visible: (sectionModel != null && sectionModel!.isProductDetails == true),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Padding(
  ...
  submit() async {
    if (selectedCategory == null) {
      ...
      if (_key.currentState?.validate() ?? false) {
        ...
        ShowToastDialog.showLoader(widget.product == null ? 'Adding product...'.tr() : 'Applying edits...'.tr());
