...
import 'package:sharehandsstore/ui/DineIn/HistoryTableBooking.dart';
import 'package:sharehandsstore/ui/DineIn/UpComingTableBooking.dart';
                      ...
                      child: Container(
                          ...
                          child: Center(
                            child: Text(
                              'Accept'.tr(),
                              style: TextStyle(
                                  color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(COLOR_PRIMARY), fontFamily: AppThemeData.medium, fontSize: 15
                      ...
                      child: Container(
                          ...
                          child: Center(
                            child: Text(
                              'Rejected'.tr(),
                              style: TextStyle(
                                  color:Colors.grey, fontFamily: AppThemeData.medium, fontSize: 15
                                // fontWeight: FontWeight.bold,
                              ),
                            ),
                          )),
