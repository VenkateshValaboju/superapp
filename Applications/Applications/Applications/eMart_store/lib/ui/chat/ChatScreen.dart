...
// import 'package:sharehandsstore/model/ChatModel.dart';
// import 'package:sharehandsstore/model/ChatVideoContainer.dart';
// import 'package:sharehandsstore/model/ConversationModel.dart';
// import 'package:sharehandsstore/model/HomeConversationModel.dart';
// import 'package:sharehandsstore/model/MessageData.dart';
...
// import 'package:sharehandsstore/ui/chat/PlayerWidget.dart';
// import 'package:sharehandsstore/ui/fullScreenImageViewer/FullScreenImageViewer.dart';
// import 'package:sharehandsstore/ui/fullScreenVideoViewer/FullScreenVideoViewer.dart';
...
//                                       'No Messages Yet'.tr(),
//                                       "Send a new message and it will show up here".tr())),
//                             );
//                           } else {
...
//               child: Container(
//                 decoration: BoxDecoration(
//                     color: Color(COLOR_ACCENT), shape: BoxShape.rectangle, borderRadius: BorderRadius.all(Radius.circular(8))),
//                 child: Padding(
//                   padding: const EdgeInsets.all(4.0),
//                   child: Stack(clipBehavior: Clip.hardEdge, alignment: Alignment.center, children: <Widget>[
//                     Padding(
...
//           lastMessage: '{} sent a message'.tr(args: ['${user.fullName()}']));
...
//               Navigator.pop(context);
//               _showAlertDialog(
//                   context, 'Block'.tr(), '{} has been blocked.'.tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             } else {
...
//             } else {
//               _showAlertDialog(
//                   context, 'Report'.tr(), "Couldn't report or block {}".tr(args: ['${homeConversationModel.members.first.fullName()}']));
//             }
//           },
//         ),
//       ],
