...
import 'package:sharehandsstore/services/send_notification.dart';
...
import 'package:sharehandsstore/widget/firebase_pagination/src/firestore_pagination.dart';
import 'package:sharehandsstore/widget/firebase_pagination/src/models/view_type.dart';
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: FirestorePagination(
                  ...
                  query: FirebaseFirestore.instance.collection('chat_store').doc(widget.orderId).collection("thread").orderBy('createdAt', descending: false),
