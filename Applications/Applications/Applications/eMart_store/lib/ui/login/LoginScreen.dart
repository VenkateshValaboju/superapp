...
import 'package:sharehandsstore/ui/phoneAuth/PhoneNumberInputScreen.dart';
import 'package:sharehandsstore/ui/resetPasswordScreen/ResetPasswordScreen.dart';
...
class _LoginScreen extends State<LoginScreen> {
              ...
              InkWell(
                ...
                child: Padding(
                  ...
                  child: Container(
                    ...
                    decoration:
                        BoxDecoration(borderRadius: BorderRadius.circular(30), color: Colors.white, border: Border.all(color: Color(COLOR_PRIMARY), width: 1)),
                    child: Padding(
  ...
  loginWithFacebook() async {
    try {
      await ShowToastDialog.showLoader('Logging in, Please wait...'.tr());
