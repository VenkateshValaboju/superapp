...
import 'package:sharehandsstore/constants.dart';
import 'package:sharehandsstore/main.dart';
import 'package:sharehandsstore/model/AttributesModel.dart';
import 'package:sharehandsstore/model/BlockUserModel.dart';
import 'package:sharehandsstore/model/BrandsModel.dart';
import 'package:sharehandsstore/model/ChatVideoContainer.dart';
import 'package:sharehandsstore/model/CurrencyModel.dart';
import 'package:sharehandsstore/model/DeliveryChargeModel.dart';
import 'package:sharehandsstore/model/OrderModel.dart';
import 'package:sharehandsstore/model/ProductModel.dart';
import 'package:sharehandsstore/model/Ratingmodel.dart';
import 'package:sharehandsstore/model/ReviewAttributeModel.dart';
import 'package:sharehandsstore/model/User.dart';
import 'package:sharehandsstore/model/VendorModel.dart';
import 'package:sharehandsstore/model/categoryModel.dart';
import 'package:sharehandsstore/model/conversation_model.dart';
import 'package:sharehandsstore/model/document_model.dart';
import 'package:sharehandsstore/model/driver_document_model.dart';
import 'package:sharehandsstore/model/email_template_model.dart';
import 'package:sharehandsstore/model/inbox_model.dart';
import 'package:sharehandsstore/model/notification_model.dart';
import 'package:sharehandsstore/model/on_boarding_model.dart';
import 'package:sharehandsstore/model/referral_model.dart';
import 'package:sharehandsstore/model/story_model.dart';
import 'package:sharehandsstore/model/topupTranHistory.dart';
import 'package:sharehandsstore/model/withdrawHistoryModel.dart';
import 'package:sharehandsstore/model/withdraw_method_model.dart';
import 'package:sharehandsstore/services/show_toast_dailog.dart';
import 'package:sharehandsstore/ui/DineIn/BookTableModel.dart';
import 'package:sharehandsstore/ui/offer/offer_model/offer_model.dart';
import 'package:sharehandsstore/ui/reauthScreen/reauth_user_screen.dart';
...
// if (docSnapshot.exists) {
  ...
  */
  ...
  Future restaurantVendorWalletSet(OrderModel orderModel) async {
    ...
    double adminComm = (orderModel.adminCommissionType!.toLowerCase() == 'Percent'.toLowerCase() || orderModel.adminCommissionType!.toLowerCase() == 'percentage'.toLowerCase())
