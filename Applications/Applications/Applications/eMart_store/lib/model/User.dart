...
class User with ChangeNotifier {
  ...
  User(
      ...
      : this.lastOnlineTimestamp = lastOnlineTimestamp ?? Timestamp.now(),
        ...
        this.appIdentifier =
            'Flutter Share Hands Store Dashboard ${Platform.operatingSystem}',
  ...
  factory User.fromJson(Map<String, dynamic> parsedJson) {
    return new User(
        ...
        isDocumentVerify: ((parsedJson.containsKey('isDocumentVerify')) ? parsedJson['isDocumentVerify'] : parsedJson['isDocumentVerify']) ?? false,
  ...
  Map<String, dynamic> toJson() {
    ...
    Map<String, dynamic> json = {
      ...
      'active': this.active,
      'isDocumentVerify': this.isDocumentVerify,
