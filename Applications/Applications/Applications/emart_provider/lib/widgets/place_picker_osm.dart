...
import 'package:sharehandsprovider/widgets/osm_map_search_place.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.my_location, color: themeChange.getTheme() ? AppColors.colorPrimary : AppColors.colorPrimary),
      ),
    );
  }
