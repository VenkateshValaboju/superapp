...
import 'package:sharehandsprovider/ui/booking_list/booking_details_screen.dart';
...
class _BookingListScreenState extends State<BookingListScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    print(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day, 23, 59));

    print(DateTime(DateTime.now().add(const Duration(days: 1)).year, DateTime.now().add(const Duration(days: 1)).month, DateTime.now().add(const Duration(days: 1)).day, 0, 0));
  }
                    ...
                    children: [
                      StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            ...
                            .where("provider.author", isEqualTo: MyAppState.currentUser!.userID)
                                                              ...
                                                              : onProviderOrder.status == ORDER_STATUS_ACCEPTED || onProviderOrder.status == ORDER_STATUS_ASSIGNED
                                                                  ? Container(
                                                                      ...
                                                                      child: Text(
                                                                        "Accepted".tr,
                                                                        style:
                                                                            TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, fontSize: 14, color: Colors.teal),
                                                                      ),
                                                                    )
                                                                  : Container(
                                                                      decoration: BoxDecoration(
                                            ...
                                            Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Container(
                                                      padding:
                                                          onProviderOrder.workerId == '' ? EdgeInsets.only(left: 10, right: 10, bottom: 10) : EdgeInsets.only(left: 10, right: 10),
                                                      child: Row(
                                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                        children: [
                                                          Text(
                                                                  ...
                                                                  onPressed: () async {
                                                                    ...
                                                                    if (onProviderOrder.provider.priceUnit == "Fixed") {
                                                                      if (onProviderOrder.payment_method.toLowerCase() != 'cod') {
                                                                        FireStoreUtils.topUpWalletAmount(userId: onProviderOrder.author.userID, amount: total.toDouble())
                                                                            .then((value) {
                      ...
                      StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance
                            ...
                            .where(
                              "newScheduleDateTime",
                              isGreaterThan: DateTime(DateTime.now().add(const Duration(days: 1)).year, DateTime.now().add(const Duration(days: 1)).month,
                                  DateTime.now().add(const Duration(days: 1)).day, 0, 0),
                            )
                            .snapshots(),
                        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                          if (snapshot.hasError) {
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  onProviderOrder.provider.priceUnit == "Hourly"
                                                      ...
                                                      : SizedBox(),
                                                  onProviderOrder.workerId != '' && onProviderOrder.workerId != null
                                                      ? FutureBuilder(
                                                          future: FireStoreUtils.getWorker(onProviderOrder.workerId.toString()),
                                                          builder: (context, snapshot) {
                                                            if (snapshot.connectionState == ConnectionState.waiting) {
                                                                  ...
                                                                  : onProviderOrder.status == ORDER_STATUS_REJECTED || onProviderOrder.status == ORDER_STATUS_CANCELLED
                                                                      ? Container(
                                                                          ...
                                                                          child: Text(
                                                                            ...
                                                                            style: TextStyle(
                                                                                fontWeight: FontWeight.bold, fontFamily: AppColors.medium, fontSize: 14, color: Colors.red),
                                                                          ),
                                                                        )
                                                                      : Container(
                                                                          decoration: BoxDecoration(
