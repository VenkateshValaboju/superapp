...
import 'package:sharehandsprovider/controller/booking_details_controller.dart';
import 'package:sharehandsprovider/model/onprovider_order_model.dart';
import 'package:sharehandsprovider/model/tax_model.dart';
import 'package:sharehandsprovider/model/user.dart';
import 'package:sharehandsprovider/services/firebase_helper.dart';
import 'package:sharehandsprovider/services/send_notification.dart';
import 'package:sharehandsprovider/themes/app_colors.dart';
import 'package:sharehandsprovider/themes/responsive.dart';
import 'package:sharehandsprovider/ui/booking_list/assign_worker_list.dart';
import 'package:sharehandsprovider/ui/booking_list/verify_otp_screen.dart';
import 'package:sharehandsprovider/ui/chat_screen/chat_screen.dart';
import 'package:sharehandsprovider/utils/dark_theme_provider.dart';
import 'package:sharehandsprovider/widgets/common_ui.dart';
...
class BookingDetailsScreen extends StatelessWidget {
          ...
          return Scaffold(
              ...
              body: controller.orderId.value.isNotEmpty
                  ? Padding(
                      ...
                      child: StreamBuilder(
                          stream: FirebaseFirestore.instance.collection(PROVIDER_ORDER).doc(controller.orderId.value).snapshots(),
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                    Text(
                                      'Booking ID'.tr,
                                      style: TextStyle(color: AppColors.colorGrey500),
                                    ),
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        Row(
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                'Date: '.tr,
                                                style: TextStyle(fontSize: 14, color: AppColors.colorGrey500, fontFamily: AppColors.medium),
                                              ),
                                            ),
                                            Padding(
                                              padding: EdgeInsets.only(top: 6),
                                              child: Text(
                                                DateFormat('dd-MMM-yyyy').format(onProviderOrder.newScheduleDateTime == null
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              padding: EdgeInsets.only(top: 6),
                                              child: Text(
                                                DateFormat('hh:mm a').format(onProviderOrder.newScheduleDateTime == null
                                                    ? onProviderOrder.scheduleDateTime!.toDate()
                                                    : onProviderOrder.newScheduleDateTime!.toDate()),
                                                style: TextStyle(
                                                  fontSize: 14,
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  controller.worker.value.profilePictureURL != ""
                                                                      ? CircleAvatar(
                                                                          backgroundImage: NetworkImage(controller.worker.value.profilePictureURL.toString()), radius: 30.0)
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                    controller.worker.value.reviewsCount != 0
                                                                          ...
                                                                          child: Row(
                                                                            ...
                                                                            children: [
                                                                              Icon(Icons.location_on_outlined,
                                                                                  size: 14, color: themeChange.getTheme() ? Colors.white : Colors.black),
                                                                              SizedBox(
                                                                                width: 5,
                                                                              ),
                                                                              Container(
                                            ...
                                            children: [
                                              onProviderOrder.author.profilePictureURL != ""
                                                  ? CircleAvatar(
                                                      ...
                                                      backgroundImage: NetworkImage(onProviderOrder.author.profilePictureURL.toString()),
                                                      radius: 30.0)
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              maxLines: 5,
                                                              style: TextStyle(
                                                                  color: themeChange.getTheme() ? Colors.white : Colors.black, fontFamily: AppColors.regular, fontSize: 14),
                                                            ),
                                                          ),
                                                        ],
                                                      ),
                                                            ...
                                                            child: ElevatedButton.icon(
                                                              ...
                                                              onPressed: () async {
                                                                ...
                                                                Get.to(ChatScreens(
                                                                    ...
                                                                    restaurantName: provider!.fullName(),
                                                              ...
                                                              label: Text(
                                                                "Chat".tr,
                                                                style: TextStyle(
                                                                    fontSize: 16, color: themeChange.getTheme() ? Colors.white : Colors.black, fontFamily: AppColors.medium),
                                                              ),
                                                            ),
                                                          ),
                                                        ],
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              "(-${amountShow(amount: controller.adminComm.toString())})",
                                ...
                                onProviderOrder.status == ORDER_STATUS_CANCELLED
                                    ...
                                    : Padding(
                                        ...
                                        child: onProviderOrder.status == ORDER_STATUS_PLACED
                                            ? Padding(
                                                      ...
                                                      child: ElevatedButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          controller.dateTimeController.value.text =
                                                              DateFormat('dd-MM-yyyy HH:mm').format(onProviderOrder.scheduleDateTime!.toDate());
                                                          showDialog(
                                                              context: context,
                                                              builder: (BuildContext context) => acceptDialog(
                                                                  context: context, controller: controller, onProviderOrder: onProviderOrder, themeChange: themeChange));
                                                        },
                                                        child: Text(
                                                          'Accept'.tr,
                                            ...
                                            : onProviderOrder.status == ORDER_STATUS_ASSIGNED && onProviderOrder.workerId == ''
                                                ? Padding(
                                                    padding: EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                                                    child: SizedBox(
                                                ...
                                                : onProviderOrder.status == ORDER_STATUS_ONGOING && onProviderOrder.workerId == ''
                                                    ? Padding(
                                                        padding: EdgeInsets.symmetric(horizontal: 10, vertical: 10),
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                    ...
                                                    : onProviderOrder.status == ORDER_STATUS_ACCEPTED && onProviderOrder.workerId == ''
                                                        ? Padding(
                                                            padding: EdgeInsets.symmetric(horizontal: 5, vertical: 5),
                                                            child: Row(
                                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget priceTotalRow(BookingDetailsController controller, OnProviderOrderModel onProviderOrder, context) {
    ...
    if (onProviderOrder.provider.disPrice == "" || onProviderOrder.provider.disPrice == "0") {
      controller.price.value = double.parse(onProviderOrder.provider.price.toString()) * onProviderOrder.quantity;
    } else {
      controller.price.value = double.parse(onProviderOrder.provider.disPrice.toString()) * onProviderOrder.quantity;
    }
    if (onProviderOrder.discountType == 'Percentage' || onProviderOrder.discountType == 'Percent') {
      controller.discount.value = controller.price.value * double.parse(onProviderOrder.discountLabel.toString()) / 100;
    } else {
      controller.discount.value = double.parse(onProviderOrder.discountLabel!.isEmpty ? "0.0" : onProviderOrder.discountLabel.toString());
    }
    ...
    controller.adminComm.value = (onProviderOrder.adminCommissionType!.toLowerCase() == 'percentage')
        ? (controller.totalAmount.value * double.parse(onProviderOrder.adminCommission!)) / 100
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              "Accept Order",
              style: TextStyle(color: themeChange.getTheme() ? Colors.white : AppColors.colorDark, fontSize: 18, fontWeight: FontWeight.bold),
            ),
            SizedBox(
              height: 10,
            ),
