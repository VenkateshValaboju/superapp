...
import 'package:sharehandsprovider/controller/bank_details_controller.dart';
import 'package:sharehandsprovider/main.dart';
import 'package:sharehandsprovider/model/FlutterWaveSettingDataModel.dart';
import 'package:sharehandsprovider/model/paypalSettingData.dart';
import 'package:sharehandsprovider/model/razorpayKeyModel.dart';
import 'package:sharehandsprovider/model/stripeSettingData.dart';
...
import 'package:sharehandsprovider/ui/bank_details/enter_bank_details_screen.dart';
                    ...
                    children: [
                            ...
                            Row(
                              children: [
                                Image.asset(
                                  ...
                                  color: themeChange.getTheme()?AppColors.colorGrey:null,
                                  height: 20,
                                ),
                                SizedBox(
                                  width: 10,
                                ...
                                Text(
                                  "Bank Transfer",
                                  style: TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, color: themeChange.getTheme()?AppColors.colorGrey:Colors.black, fontSize: 16),
                                )
                              ],
                            ),
                            isBankDetailsAdded
                      ...
                      Padding(
                        ...
                        child: isBankDetailsAdded
                            ? Text(
                          "Setup was Done",
                          style: TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, color: Colors.green),
                        )
                            : Row(
                          children: [
                            Text(
                              "Setup is Pending.".tr,
                              style: TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, color: Colors.orange),
                            ),
                            SizedBox(
                              width: 5,
                            ),
                            InkWell(
                              ...
                              child: Text(
                                "Setup Now".tr,
                                style:
                                TextStyle(fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontFamily: AppColors.medium, color: Colors.blue),
                              ),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: Text(
                                "Setup Now".tr,
                                style: TextStyle(
                                    fontWeight: FontWeight.bold, decoration: TextDecoration.underline, fontFamily: AppColors.medium, color: Colors.blue),
                              ),
                            ),
                          ],
                        ),
            ...
            children: [
              ...
              TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: TextStyle(color: themeChange.getTheme() ? Colors.white : Color(0Xff333333), fontFamily: "Poppinsm", fontSize: 16),
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      color: themeChange.getTheme() ? Colors.white : Colors.white,
                    ),
                  ),
                  onPressed: () async {
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, color: themeChange.getTheme() ? Colors.white : Colors.grey),
                ),
              ),
              SizedBox(
                height: 20,
