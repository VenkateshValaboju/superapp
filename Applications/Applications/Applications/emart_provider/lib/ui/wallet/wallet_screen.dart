...
import 'package:sharehandsprovider/controller/wallet_controller.dart';
...
import 'package:sharehandsprovider/ui/wallet/withdraw_history.dart';
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(16)), image: DecorationImage(fit: BoxFit.fitWidth, image: AssetImage("assets/images/wallet_img_@3x.png"))),
                      child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Column(
    ...
    return controller.topupHistoryQuery.isEmpty
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              TopupTranHistoryModel topUpTranHistory = controller.topupHistoryQuery[index];
              return Padding(
                          ...
                          ClipOval(
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Icon(Icons.account_balance_wallet_rounded, size: 28, color: AppColors.colorPrimary),
                              ),
                            ),
                          ),
                          Expanded(
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      "Bank Transfer",
                                                      style: TextStyle(fontWeight: FontWeight.bold, fontFamily: AppColors.medium, color: Colors.black, fontSize: 16),
                                                    )
                                                  ],
                                                ),
                                                Radio(
                        ...
                        Padding(
                          ...
                          child: RichText(
                            text: TextSpan(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                color: themeChange.getTheme() ? Colors.white70 : Colors.black.withOpacity(0.7),
                              ),
                            ),
                          ),
                        ),
