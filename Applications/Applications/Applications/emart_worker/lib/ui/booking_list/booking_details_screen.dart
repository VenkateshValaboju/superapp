...
import 'package:sharehands_worker/constant/show_toast_dialog.dart';
import 'package:sharehands_worker/controller/booking_details_controller.dart';
import 'package:sharehands_worker/model/onprovider_order_model.dart';
import 'package:sharehands_worker/model/tax_model.dart';
import 'package:sharehands_worker/model/user.dart';
import 'package:sharehands_worker/model/worker_model.dart';
import 'package:sharehands_worker/services/firebase_helper.dart';
import 'package:sharehands_worker/services/send_notification.dart';
import 'package:sharehands_worker/themes/app_colors.dart';
import 'package:sharehands_worker/ui/booking_list/verify_otp_screen.dart';
import 'package:sharehands_worker/ui/chat_screen/chat_screen.dart';
import 'package:sharehands_worker/utils/dark_theme_provider.dart';
import 'package:sharehands_worker/widgets/common_ui.dart';
...
class BookingDetailsScreen extends StatelessWidget {
                                                          ...
                                                          Expanded(
                                                            child: ElevatedButton.icon(
                                                              ...
                                                              onPressed: () async {
                                                                ...
                                                                WorkerModel? provider = await FireStoreUtils.getWorkerCurrentUser(onProviderOrder.workerId.toString());
  ...
  Widget priceTotalRow(BookingDetailsController controller, onProviderOrder, context) {
    ...
    if (onProviderOrder.discountType == 'Percentage' || onProviderOrder.discountType == 'Percent') {
      ...
      controller.discount.value = double.parse(onProviderOrder.discountLabel.toString());
    }
    ...
    controller.adminComm.value = (onProviderOrder.adminCommissionType == 'Percent')
