...
import 'package:sharehandscustomer/services/notification_service.dart';
...
import 'package:sharehandscustomer/ui/location_permission_screen.dart';
import 'package:sharehandscustomer/ui/onBoarding/on_boarding_screen.dart';
import 'package:sharehandscustomer/userPrefrence.dart';
import 'package:sharehandscustomer/utils/Styles.dart';
...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void initializeFlutterFire() async {
    try {
      ...
      await FireStoreUtils.firestore.collection(Setting).doc("placeHolderImage").get().then((value) {
        placeholderImage = value.data()!['image'].toString();
      });

      SharedPreferences sp = await SharedPreferences.getInstance();
      if(sp.getString("languageCode") != null || sp.getString("languageCode")!.isNotEmpty){
