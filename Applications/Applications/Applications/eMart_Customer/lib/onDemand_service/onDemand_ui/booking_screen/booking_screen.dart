...
import 'package:sharehandscustomer/onDemand_service/onDemand_ui/ondemand_payment_screen/ondemand_payment_screen.dart';
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text("Services", style: TextStyle(fontFamily: AppThemeData.regular, fontSize: 16)),
              ),
              Container(
                      ...
                      Expanded(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(fontFamily: AppThemeData.regular, fontSize: 16, fontWeight: FontWeight.bold),
                          ),
                          SizedBox(
                            height: 5,
                          ),
                          Text(
                            ...
                            style: TextStyle(fontFamily: AppThemeData.regular, fontSize: 14, fontWeight: FontWeight.w400),
                          ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "Address".tr(),
                              style: const TextStyle(fontFamily: AppThemeData.regular, fontWeight: FontWeight.w700),
                            ),
                            SizedBox(
                              height: 5,
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          "Change",
                          style: TextStyle(fontFamily: AppThemeData.regular, color: AppThemeData.primary300),
                        ),
                      )
                    ],
                  )),
              ...
              Text("Description", style: TextStyle(fontFamily: AppThemeData.regular, fontSize: 16)),
              SizedBox(
                height: 10,
              ),
              Theme(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: isDarkMode(context) ? Colors.grey.shade900 : AppThemeData.primary300, width: 2.0)),
              ...
              Text("Booking Date & Slot", style: TextStyle(fontFamily: AppThemeData.regular, fontSize: 16)),
              SizedBox(
                height: 10,
              ),
              InkWell(
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Text(
                            "Price Detail",
                            style: TextStyle(fontFamily: AppThemeData.regular, fontWeight: FontWeight.bold, fontSize: 16),
                          ),
                        ),
                        priceTotalRow(),
                      ],
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(fontFamily: AppThemeData.regular, fontWeight: FontWeight.w500, color: isDarkMode(context) ? Colors.white : Colors.black),
                          ),
                        ),
                        Text(
                          amountShow(amount: getTaxValue(amount: (double.parse(subTotal.toString())).toString(), taxModel: taxModel).toString()),
                          style: TextStyle(fontFamily: AppThemeData.regular, fontWeight: FontWeight.w500, color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 12),
                        ),
                      ],
                    ),
                  ),
