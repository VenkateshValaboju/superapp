...
import 'package:sharehandscustomer/onDemand_service/onDemand_ui/review_screen/ondemand_review_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: onProviderOrder != null
          ? StreamBuilder(
              stream: FireStoreUtils.firestore.collection(PROVIDER_ORDER).doc(onProviderOrder!.id).snapshots(),
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                                color: isDarkMode(context) ? Colors.white : Colors.black, fontSize: 16,  fontFamily: AppThemeData.regular, fontWeight: FontWeight.bold),
                                          ),
                                        ),
                                        Row(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                    fontSize: 14,  fontFamily: AppThemeData.regular, fontWeight: FontWeight.normal, color: isDarkMode(context) ? Colors.white : Colors.black),
                                              ),
                                            ),
                                          ],
                                        ),
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              decoration: BoxDecoration(
                                                                                  color: AppThemeData.warning400, borderRadius: BorderRadius.all(Radius.circular(16))),
                                                                              child: Padding(
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            decoration: BoxDecoration(color: AppThemeData.warning400, borderRadius: BorderRadius.all(Radius.circular(16))),
                                                            child: Padding(
                                                              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                                                              child: Row(
                                                                mainAxisSize: MainAxisSize.min,
                                                      ...
                                                      Text(
                                                        ...
                                                        style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black,  fontFamily: AppThemeData.regular, fontSize: 14),
                                                      ),
                                                    ],
                                                  ),
                                                ),
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: ElevatedButton(
                                                    style: ElevatedButton.styleFrom(
                                                      ...
                                                      side: BorderSide(color: AppThemeData.primary300, width: 0.4),
                                                      shape: RoundedRectangleBorder(
    ...
    return AlertDialog(
      ...
      content: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(7.0), borderSide: BorderSide(color: AppThemeData.primary300, width: 2.0)),
