...
import 'package:sharehandscustomer/onDemand_service/onDemand_ui/order_screen/ondemand_order_details_screen.dart';
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ...
                                              onProviderOrder.status == ORDER_STATUS_PLACED
                                                  ...
                                                  : onProviderOrder.status == ORDER_STATUS_ACCEPTED || onProviderOrder.status == ORDER_STATUS_ASSIGNED
                                                      ? Container(
                                                          ...
                                                          child: Text(
                                                            "Accepted",
                                                            style: TextStyle(fontWeight: FontWeight.bold,  fontFamily: AppThemeData.regular, fontSize: 14, color: Colors.teal),
                                                          ),
                                                        )
                                                      : onProviderOrder.status == ORDER_STATUS_ONGOING
                                                          ? Container(
                                                              ...
                                                              child: Text(
                                                                "On Going",
                                                                style: TextStyle(fontWeight: FontWeight.bold,  fontFamily: AppThemeData.regular, fontSize: 14, color: Colors.lightGreen),
                                                              ),
                                                            )
                                                          : onProviderOrder.status == ORDER_STATUS_COMPLETED
                                                              ? Container(
                                                                  ...
                                                                  child: Text(
                                                                    "Completed",
                                                                    style: TextStyle(fontWeight: FontWeight.bold,  fontFamily: AppThemeData.regular, fontSize: 14, color: Colors.green),
                                                                  ),
                                                                )
                                                              : onProviderOrder.status == ORDER_STATUS_REJECTED
                                                                  ? Container(
                                                                      ...
                                                                      child: Text(
                                                                        "Rejected",
                                                                        style: TextStyle(fontWeight: FontWeight.bold,  fontFamily: AppThemeData.regular, fontSize: 14, color: Colors.red),
                                                                      ),
                                                                    )
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: isDarkMode(context) ? Colors.grey.shade900 : AppThemeData.grey200,
                                  ),
                                  child: Padding(
