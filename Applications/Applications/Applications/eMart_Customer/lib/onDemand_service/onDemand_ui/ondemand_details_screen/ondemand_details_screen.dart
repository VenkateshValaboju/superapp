...
import 'package:sharehandscustomer/onDemand_service/onDemand_ui/booking_screen/booking_screen.dart';
import 'package:sharehandscustomer/onDemand_service/onDemand_ui/provider_screen/provider_screen.dart';
      ...
      children: [
        ElevatedButton(
          ...
          style: ButtonStyle(
              ...
              backgroundColor: tabString == "About"
                  ? WidgetStateProperty.all<Color>(AppThemeData.primary300)
        ...
        provider.photos.isEmpty
            ...
            : ElevatedButton(
                ...
                style: ButtonStyle(
                    foregroundColor:
                        tabString == "Gallery" ? WidgetStateProperty.all<Color>(Colors.white) : WidgetStateProperty.all<Color>(isDarkMode(context) ? Colors.white : Colors.black),
        ...
        ratingService.isEmpty
            ...
            : ElevatedButton(
                ...
                style: ButtonStyle(
                    foregroundColor:
                        tabString == "Review" ? WidgetStateProperty.all<Color>(Colors.black) : WidgetStateProperty.all<Color>(isDarkMode(context) ? Colors.white : Colors.black),
