  ...
  buildCategory({required String title, required String icon, required int index}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        width: 165,
        decoration: BoxDecoration(
          color: selectedIndex == index ? AppThemeData.primary300 : Colors.grey.shade100,
          borderRadius: BorderRadius.circular(8),
        ),
        child: Padding(
          ...
          Row(
            children: [
              Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(shape: BoxShape.circle, color: AppThemeData.primary300),
                  child: const Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(fontSize: 16, fontFamily: AppThemeData.medium),
                                )
                              ],
                            ),
                          ),
                            ...
                            onPress: () async {
                              if (selectedMapType == 'osm') {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => LocationPicker())).then(
                                  (value) {
                                    if (value != null) {
                                      senderAddress = value.displayName!.toString();
                                      senderLocation = UserLocation(latitude: value.lat, longitude: value.lon);
                                      setState(() {});
                                    }
                                  },
                                );
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 16, color: AppThemeData.primary300),
                ),
              ),
            ],
          ),
                            ...
                            onPress: () async {
                              if (selectedMapType == 'osm') {
                                Navigator.of(context).push(MaterialPageRoute(builder: (context) => LocationPicker())).then(
                                      (value) {
                                    if (value != null) {
                                      receiverAddress = value.displayName!.toString();
                                      receiverLocation = UserLocation(latitude: value.lat, longitude: value.lon);
                                      setState(() {});
                                    }
                                  },
                                );
