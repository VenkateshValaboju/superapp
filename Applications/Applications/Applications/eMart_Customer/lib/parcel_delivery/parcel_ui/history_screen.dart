...
import 'package:sharehandscustomer/parcel_delivery/parcel_ui/parcel_order_track_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ordersList.isEmpty
          ? Center(
              child: Text("Parcel Booking not found"),
            )
          : ListView.builder(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    buildOtherDetails(title: "Rate".tr(), value: amountShow(amount: orderModel.subTotal!), color: AppThemeData.primary300),
                  ],
                ),
              ],
            ),
            ...
            child: Row(
              children: [
                Text(
                  ...
                  style: TextStyle(fontSize: 18, color: isSender ? AppThemeData.primary300 : const Color(0xffd17e19)),
                ),
                Text(
