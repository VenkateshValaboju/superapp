...
import 'package:sharehandscustomer/widget/my_separator.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';

class RentalReviewScreen extends StatefulWidget {
  final RentalOrderModel order;

  const RentalReviewScreen({Key? key, required this.order}) : super(key: key);
...
class _RentalReviewScreenState extends State<RentalReviewScreen> with TickerProviderStateMixin {
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("${widget.order.driver!.firstName} ${widget.order.driver!.lastName}",
                                          style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black87,  fontFamily: AppThemeData.medium, fontSize: 18)),
                                    ),
                                    Padding(
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(driverUser!.carNumber.toUpperCase().toString(),
                                        style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black87,  fontFamily: AppThemeData.medium)),
                                    Padding(
                                      padding: const EdgeInsets.only(left: 8.0),
                                      child: Text("${driverUser!.carName} ${driverUser!.carMakes}",
                                          style: TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black38,  fontFamily: AppThemeData.medium)),
                                    ),
                                  ],
                                ),
                                const Padding(
  ...
  //     User? user = await FireStoreUtils().getUserByIDS(widget.order.driverID.toString());
  //     if (user != null) {
  //       user.reviewsCount = futureCount + 1;
  //       user.reviewsSum = futureSum + ratings;
  //     }
