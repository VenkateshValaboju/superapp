                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: const TextStyle(fontSize: 18, color: Colors.white,  fontFamily: AppThemeData.medium),
                              ),
                              const SizedBox(
                                height: 4,
                              ),
                          ...
                          Visibility(
                            ...
                            child: Expanded(
                              child: ElevatedButton(
                                ...
                                child: Text(
                                  'Cancel Ride'.tr(),
                                  style: const TextStyle(color: Colors.white,  fontFamily: AppThemeData.medium, fontSize: 16),
                                ),
                              ),
                            ),
                          ),
