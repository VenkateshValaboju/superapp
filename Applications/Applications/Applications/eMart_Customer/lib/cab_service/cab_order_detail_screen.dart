...
import 'package:sharehandscustomer/cab_service/cab_review_screen.dart';
import 'package:sharehandscustomer/cab_service/cab_service_screen.dart';
...
class CabOrderDetailScreen extends StatefulWidget {
  ...
  const CabOrderDetailScreen({Key? key, this.orderModel, this.orderId}) : super(key: key);
        ...
        Row(
          ...
          children: [
            Text(
              ...
              style: TextStyle(fontSize: 16, fontFamily: AppThemeData.semiBold),
            ),
            Padding(
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              amountShow(
                                  amount: getTaxValue(
                                          amount: (double.parse(orderModel!.subTotal.toString()) - double.parse(orderModel!.discount.toString())).toString(), taxModel: taxModel)
                                      .toString()),
                              style: TextStyle(
                                fontSize: 16,
                                fontFamily: AppThemeData.semiBold,
