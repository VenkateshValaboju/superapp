...
import 'package:sharehandscustomer/cab_service/cab_home_screen.dart';
import 'package:sharehandscustomer/cab_service/cab_order_screen.dart';
...
enum DrawerSelection { Dashboard, Home, Wallet, Profile, Orders, termsCondition, privacyPolicy, chooseLanguage, driver, Logout, giftCard, referral }
          ...
          builder: (context, user, _) {
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                title: _drawerSelection == DrawerSelection.Home
                    ? null
                    : Text(
                        _appBarTitle,
                        style: TextStyle(
