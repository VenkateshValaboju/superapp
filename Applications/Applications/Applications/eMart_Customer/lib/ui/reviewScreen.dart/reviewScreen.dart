...
import 'package:sharehandscustomer/ui/fullScreenImageViewer/fullscreenimage.dart';
                              ...
                              child: Card(
                                  ...
                                  child: SizedBox(
                                      ...
                                      child: Column(children: [
                                        ...
                                        Text("Add Images".tr(), style: const TextStyle(color: Color(0XFF666666), fontSize: 16))
                                      ]))),
                            ),
                            _mediaFiles.isEmpty
                                ? Container()
                                        ...
                                        child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                  ...
                                                  hintStyle: TextStyle(color: isDarkMode(context) ? const Color(0xff35363A) : Color(0XFF8A8989)),
        ...
        bottomNavigationBar: ratingModel != null
            ? Padding(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'UPDATE REVIEW'.tr(),
                    style: TextStyle(color: isDarkMode(context) ? Colors.black : Colors.white, fontSize: 17),
                  ),
                ),
              )
            : Padding(
        ...
        child: Card(
          ...
          child: ClipRRect(
            ...
            child: image is File
                ...
                : NetworkImageWidget(imageUrl: image),
          ),
        ),
        // ),
      ),
