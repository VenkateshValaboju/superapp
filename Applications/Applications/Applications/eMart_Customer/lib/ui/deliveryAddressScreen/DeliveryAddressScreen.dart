...
//                       //       borderRadius: BorderRadius.circular(8.0),
//                       //       borderSide:
//                       //           BorderSide(color: AppThemeData.primary300, width: 2.0),
//                       //     ),
...
import 'package:sharehandscustomer/ui/deliveryAddressScreen/add_address_screen.dart';
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Add",
                        style: TextStyle(color: Colors.white, fontFamily: AppThemeData.semiBold),
                      ),
                      SizedBox(
                        width: 5,
                      ),
                                  ...
                                  children: [
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            ...
                                            style: TextStyle(fontFamily: AppThemeData.regular, color: isDarkMode(context) ? Colors.white : Colors.black.withOpacity(0.80)),
                                          ),
                                        )
                                      ],
                                    ),
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          height: 32,
                                          decoration: BoxDecoration(color: AppThemeData.primary300, borderRadius: const BorderRadius.all(Radius.circular(20))),
                                          child: Padding(
