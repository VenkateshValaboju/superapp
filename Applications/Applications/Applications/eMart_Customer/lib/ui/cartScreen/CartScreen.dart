...
class _CartScreenState extends State<CartScreen> {
  ...
  getFoodType() async {
    ...
    await FireStoreUtils.firestore.collection(Setting).doc('specialDiscountOffer').get().then((value) {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle( fontFamily: AppThemeData.regular, color: Colors.red, fontSize: _font),
                      ),
                    ],
                  )),
              const Divider(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle( fontFamily: AppThemeData.regular, fontSize: _font),
                              ),
                            ),
                            Text(
                              amountShow(
                              ...
                              style: TextStyle( fontFamily: AppThemeData.regular, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: _font),
                            ),
                          ],
                        ),
                      ),
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: AppThemeData.primary300, textStyle: const TextStyle(fontSize: 15, fontWeight: FontWeight.normal)),
