...
import 'package:sharehandscustomer/ui/gift_card/gift_card_history_list_screen.dart';
import 'package:sharehandscustomer/ui/gift_card/gift_card_purchase_screen.dart';
import 'package:sharehandscustomer/ui/gift_card/gift_card_redeem_screen.dart';
...
class _GiftCardScreenState extends State<GiftCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Customize Gift Card", style: TextStyle(color: AppThemeData.primary300, fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: [
          InkWell(
              onTap: () {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text("Choose amount".toUpperCase(),
                                style: TextStyle(fontSize: 16, color: isDarkMode(context) ? Colors.grey.shade700 : Colors.grey.shade700,  fontFamily: AppThemeData.medium)),
                          ),
                          Expanded(child: Divider()),
                        ],
                      ),
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            height: 60,
                                            decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(14)), border: Border.all(color: AppThemeData.primary300)),
                                            child: Padding(
                                      ...
                                      InkWell(
                                          ...
                                          child: Text("Add", style: TextStyle(color: AppThemeData.primary300))),
                                    ],
                                  )
                                : Container(
                                    height: 60,
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                                        ...
                                                        border: Border.all(color: selectedAmount == amount[index] ? AppThemeData.primary300 : Colors.grey)),
                                                    child: Padding(
                                                      padding: const EdgeInsets.symmetric(horizontal: 10),
                                            ...
                                            child: Padding(
                                              ...
                                              child: Container(
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(
                                                        color:
                                                            selectedAmount != "1000" && selectedAmount != "2000" && selectedAmount != "5000" ? AppThemeData.primary300 : Colors.grey)),
                                                child: Padding(
