        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                "COPY CODE".tr(),
                style: TextStyle(color: AppThemeData.primary300, fontWeight: FontWeight.w500, letterSpacing: 0.1),
              ),
            ),
          ),
          Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text(
                                          ...
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, letterSpacing: 0.5, color: AppThemeData.primary300),
                                        )),
                                  ),
                                ),
                              ),
