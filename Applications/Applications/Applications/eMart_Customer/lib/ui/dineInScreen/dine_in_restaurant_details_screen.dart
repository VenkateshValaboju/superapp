...
import 'package:sharehandscustomer/ui/vendorProductsScreen/photos.dart';
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                    onTap: () async {
                                      await Share.share(subject: widget.vendorModel.title,"${widget.vendorModel.location} \n${widget.vendorModel.photo}");
                                    },
                            ...
                            GestureDetector(
                              ...
                              child: Align(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(100), border: Border.all(width: 1, color: isDarkMode(context) ? AppThemeData.primary300 : Colors.black54)),
                                    child: Icon(
                                      Icons.keyboard_arrow_right,
                                      color: isDarkMode(context) ? AppThemeData.primary300 : Colors.black54,
                                    ),
                                  )),
                            ),
                          ],
                          ...
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              children: <Widget>[
                                ...tags
                                    .map((tag) => FilterChip(
                                          labelStyle: TextStyle(color: AppThemeData.primary300),
                                          label: Text("$tag"),
