...
class _OrdersScreenState extends State<OrdersScreen> {
        ...
        child: Padding(
          ...
          child: GestureDetector(
              ...
              child: Column(children: [
                ...
                //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: AppThemeData.primary300)),
                //       child: Center(
                //         child: Text(
                //           'REORDER'.tr(),
  ...
  getPriceTotalText(CartProduct s) {
    ...
    return Text(
      ...
      style: TextStyle(fontSize: 20, color: isDarkMode(context) ? Colors.grey.shade200 : AppThemeData.primary300),
    );
  }
}
