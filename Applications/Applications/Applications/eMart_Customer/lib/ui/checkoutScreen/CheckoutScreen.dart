...
import 'package:sharehandscustomer/ui/placeOrderScreen/PlaceOrderScreen.dart';
              ...
              children: [
                Container(
                  ...
                  child: ListTile(
                    leading: Text(
                      'Payment'.tr(),
                      style: TextStyle(color: AppThemeData.primary300, fontWeight: FontWeight.bold, fontSize: 18),
                    ),
                    trailing: Text(
