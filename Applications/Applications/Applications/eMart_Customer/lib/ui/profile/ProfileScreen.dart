...
import 'package:sharehandscustomer/ui/accountDetails/AccountDetailsScreen.dart';
import 'package:sharehandscustomer/ui/auth_screen/login_screen.dart';

import 'package:sharehandscustomer/ui/contactUs/ContactUsScreen.dart';
import 'package:sharehandscustomer/ui/settings/SettingsScreen.dart';
  ...
  showDeleteAccountAlertDialog(BuildContext context) {
    ...
    Widget okButton = TextButton(
      ...
      onPressed: () async {
        ...
        //   if (value == true) {
        //     ShowToastDialog.showToast("Account delete".tr);
        //    pushAndRemoveUntil(Get.context!, LoginScreen());
        //   }
        // });
      },
    );
