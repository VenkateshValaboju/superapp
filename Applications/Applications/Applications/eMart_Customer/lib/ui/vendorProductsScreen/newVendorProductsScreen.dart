...
import 'package:sharehandscustomer/model/WorkingHoursModel.dart';
...
import 'package:sharehandscustomer/ui/review_list_screen/review_list_screen.dart';
  ...
  getVendorCategoryById() async {
    ...
    for (var element in productList) {
      FireStoreUtils.getVendorCategoryById(element.categoryID.toString()).then(
        (value) {
          if (value != null) {
            if (vendorCategoryList.where((element) => element.id == value.id).isEmpty) {
                          ...
                          onTap: () async {
                            if (favouriteList.where((p0) => p0.store_id == widget.vendorModel.id).isNotEmpty) {
                              FavouriteModel favouriteModel = FavouriteModel(
                                  section_id: sectionConstantModel!.id, store_id: widget.vendorModel.id, user_id: MyAppState.currentUser!.userID);
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              calculateReview(
                                                  reviewCount: widget.vendorModel.reviewsCount.toStringAsFixed(0),
                                                  reviewSum: widget.vendorModel.reviewsSum.toString()),
                                              style: TextStyle(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: isVag
                                              ...
                                              : ShapeDecoration(
                                                  ...
                                                  shape: RoundedRectangleBorder(
                                                    side: BorderSide(
                                                        width: 1, color: isDarkMode(context) ? AppThemeData.grey700 : AppThemeData.grey200),
                                                    borderRadius: BorderRadius.circular(120),
                                                  ),
                                                ),
                                          child: Row(
                                                    ...
                                                    Expanded(
                                                      child: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            ...
                                                            border:
                                                                Border.all(color: isDarkMode(context) ? AppThemeData.grey400 : AppThemeData.grey200)),
                                                        child: Center(
                                                          child: Text(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (productModel.itemAttributes != null) {
                    ...
                    if (productModel.itemAttributes!.variants!.where((element) => element.variant_sku == selectedVariants.join('-')).isNotEmpty) {
                      price = productCommissionPrice(productModel.itemAttributes!.variants!
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: const TextStyle(
                                              fontSize: 14, fontWeight: FontWeight.bold, color: Colors.grey, decoration: TextDecoration.lineThrough),
                                        ),
                                      ],
                                    ),
                              Row(
                                        ...
                                        onPress: () async {
                                          await Navigator.of(context)
                                              .push(MaterialPageRoute(
                                                  builder: (context) =>
                                                      ProductDetailsScreen(productModel: productModel, vendorModel: widget.vendorModel)))
                                              .whenComplete(() {
                                            setState(() {});
                                          });
                                        },
